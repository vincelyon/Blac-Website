  ...
  return (
    <div style={{ marginTop: '5px' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
        {items.map((item) => (
          <div key={item.id} style={{ marginBottom: '20px', padding: '20px', border: '1px solid #ccc', borderRadius: '8px', backgroundColor: '#858576', flex: '0 0 calc(33.33% - 20px)', margin: '10px', minWidth: '250px' }}>
            <h3>{item.itemName}</h3>
