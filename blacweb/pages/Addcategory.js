        ...
        <div style={{ width: '80%', maxWidth: '600px', padding: '20px', borderRadius: '10px', background: '#fff', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <input
              ...
              style={{ padding: '8px', marginBottom: '20px', width: '100%', maxWidth: '300px', borderRadius: '5px', border: '1px solid #ccc' }}
            />
            ...
            {categoryImage && (
              <img
                src={categoryImage}
                alt="Category"
                style={{ maxWidth: '300px', width: '100%', marginTop: '10px', borderRadius: '5px', border: '1px solid #ccc' }}
              />
            )}
            <button
              type="submit"
              style={{ padding: '10px 20px', backgroundColor: '#007bff', color: '#fff', border: 'none', borderRadius: '5px', cursor: 'pointer', width: '100%', maxWidth: '300px' }}
            >
              Submit
            </button>
          </form>
